            ...
            <form onSubmit={editingAnalyst ? handleUpdateAnalyst : handleAddAnalyst}>
              ...
              <div className="flex items-center space-x-4 mt-6">
                ...
                <button
                  ...
                  className="px-6 py-2 bg-muted text-gray-700 dark:text-gray-200 rounded-lg hover:bg-muted/80"
                >
                  Cancel
                </button>
              </div>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex items-center space-x-2">
                        ...
                        <button
                          ...
                          className={`transition-colors ${analyst.isActive
                            ? 'text-orange-600 hover:text-orange-800'
                            : 'text-green-600 hover:text-green-800'
                            }`}
                          title={analyst.isActive ? 'Deactivate analyst' : 'Activate analyst'}
                        >
                          {analyst.isActive ? <UserMinusIcon className="h-4 w-4" /> : <UserPlusIcon className="h-4 w-4" />}
                        </button>
                        <button
