                    ...
                    <div className="space-y-1.5">
                        {screeners.map((screener, index) => (
                            <div
                                ...
                                className={`flex items-center p-1.5 rounded-xl border transition-colors ${screener.shiftType === 'MORNING'
                            ...
                            >
                                <div className={`w-7 h-7 rounded-lg flex items-center justify-center font-bold text-[10px] mr-2 shadow-sm ${screener.shiftType === 'MORNING'
