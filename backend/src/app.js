...
app.use('/api', SecurityService_1.securityService.createRateLimitMiddleware(SecurityService_1.securityService.getConfig().rateLimits.api));
// Request logging middleware
app.use((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const startTime = Date.now();
    // Log request start
    yield SecurityService_1.securityService.logAuditEvent('REQUEST_START', 'api', undefined, {
        method: req.method,
        url: req.url,
        ip: req.ip,
    ...
    res.end = function (chunk, encoding) {
        ...
        SecurityService_1.securityService.logAuditEvent('REQUEST_END', 'api', undefined, {
            method: req.method,
            url: req.url,
...
app.use((err, req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // Log audit event
    yield SecurityService_1.securityService.logAuditEvent('ERROR', 'api', undefined, {
        error: err.message,
        stack: err.stack,
        url: req.url,
        method: req.method,
