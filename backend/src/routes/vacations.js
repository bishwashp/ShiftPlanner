...
router.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const vacations = yield app_1.prisma.vacation.findMany({
            where,
            include: {
                analyst: true
            },
...
router.get('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const vacation = yield app_1.prisma.vacation.findUnique({
            where: { id },
...
router.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const vacation = yield app_1.prisma.vacation.create({
            data: {
                analystId,
...
router.put('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const vacation = yield app_1.prisma.vacation.update({
            where: { id },
            data: {
...
router.delete('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        yield app_1.prisma.vacation.delete({ where: { id } });
        res.status(204).send();
    }
    catch (error) {
